...
function showCheckout() {
    ...
    const savedAddress = {
        ...
        cidade: user.endereco_cidade || 'São Paulo',
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        ${savedAddress.rua ? '<a href="#" onclick="showProfile(); return false;" class="small text-primary">Alterar padrão</a>' : ''}
                    </div>
                    <form id="addressForm">
                        <div class="mb-2">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-4">
                                <input type="text" class="form-control" id="cep" placeholder="CEP" 
                                       value="${savedAddress.cep}" required>
                            </div>
                        </div>
                        <div class="mb-0">
