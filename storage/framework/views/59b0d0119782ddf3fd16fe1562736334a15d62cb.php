...
<div class="container-fluid">
 ...
 <a href="<?php echo e(route('mesas.index')); ?>" class="btn btn-primary btn-lg w-100">
 <i class="fas fa-list"></i><br>Ver Todas as Mesas
 </a>
 </div>
 <div class="col-md-3 mb-3">
 <a href="<?php echo e(route('mesas.create')); ?>" class="btn btn-success btn-lg w-100">
 <i class="fas fa-plus"></i><br>Nova Mesa
 </a>
 </div>
 <div class="col-md-3 mb-3">
 <a href="<?php echo e(route('garcom.mesas')); ?>" class="btn btn-warning btn-lg w-100">
 ...
 <div class="row">
 <div class="col-md-3 mb-3">
 <a href="<?php echo e(route('deliveries.index')); ?>" class="btn btn-primary btn-lg w-100">
 <i class="fas fa-list"></i><br>Ver Todas as Entregas
 </a>
 </div>
 <div class="col-md-3 mb-3">
 <a href="<?php echo e(route('deliveries.create')); ?>" class="btn btn-success btn-lg w-100">
 <i class="fas fa-plus"></i><br>Nova Entrega
 </a>
 </div>
 <div class="col-md-3 mb-3">
 <a href="<?php echo e(route('deliveries.index', ['status' => 'preparando'])); ?>" class="btn btn-warning btn-lg w-100">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myd_bar_restaurantes\resources\views/dashboard.blade.php ENDPATH**/ ?>