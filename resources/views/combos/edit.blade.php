    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                ...
                <p class="page-subtitle">Atualize as informações do combo</p>
            </div>
        ...
        <div class="card-body">
            @if ($errors->any())
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <h5 class="alert-heading"><i class="fas fa-exclamation-triangle me-2"></i>Erro ao atualizar combo!</h5>
                    <hr>
                    <ul class="mb-0">
            ...
            <form action="{{ route('combos.update', $combo) }}" method="POST" enctype="multipart/form-data" id="comboForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" name="nome" class="form-control @error('nome') is-invalid @enderror" 
                                   value="{{ old('nome', $combo->nome) }}" required>
                            @error('nome')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="descricao" class="form-control @error('descricao') is-invalid @enderror" 
                                      rows="3">{{ old('descricao', $combo->descricao) }}</textarea>
                            @error('descricao')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @if($combo->imagem)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $combo->imagem) }}" alt="Imagem atual" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                            ...
                            <div id="imagemPreview" class="mt-2" style="display: none;">
                                ...
                                <small class="text-muted d-block">Nova imagem</small>
                            </div>
                        </div>

                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="destaque" id="destaque" value="1" {{ old('destaque', $combo->destaque) ? 'checked' : '' }}>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="preco_combo" id="preco_combo" 
                                           ...
                                           step="0.01" min="0" value="{{ old('preco_combo', $combo->preco_combo) }}" required>
                                    @error('preco_combo')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
...
// Controle do alerta de destaque
document.getElementById('destaque').addEventListener('change', function() {
    document.getElementById('alerta_destaque').style.display = this.checked ? 'block' : 'none';
});
