...
<div class="container-fluid">
 ...
 value="{{ old('nome_completo', $funcionario->nome_completo) }}" required>
 @error('nome_completo')
 ...
 value="{{ old('cpf', $funcionario->cpf) }}" maxlength="14" placeholder="000.000.000-00" required>
 @error('cpf')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 value="{{ old('telefone', $funcionario->telefone) }}" placeholder="(00) 0000-0000">
 @error('telefone')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 value="{{ old('celular', $funcionario->celular) }}" placeholder="(00) 00000-0000">
 @error('celular')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 value="{{ old('cep', $funcionario->cep) }}" maxlength="10" placeholder="00000-000">
 @error('cep')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 value="{{ old('numero', $funcionario->numero) }}" maxlength="10">
 @error('numero')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 value="{{ old('estado', $funcionario->estado) }}" maxlength="2" placeholder="SP">
 @error('estado')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 value="{{ old('pis_pasep', $funcionario->pis_pasep) }}" maxlength="20">
 @error('pis_pasep')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 value="{{ old('titulo_eleitor', $funcionario->titulo_eleitor) }}" maxlength="20">
 ...
 value="{{ old('carteira_trabalho', $funcionario->carteira_trabalho) }}" maxlength="20">
 ...
 value="{{ old('banco', $funcionario->banco) }}">
 @error('banco')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 <option value="corrente" {{ old('tipo_conta', $funcionario->tipo_conta) == 'corrente' ? 'selected' : '' }}>Corrente</option>
 <option value="poupanca" {{ old('tipo_conta', $funcionario->tipo_conta) == 'poupanca' ? 'selected' : '' }}>Poupança</option>
 </select>
 @error('tipo_conta')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 ...
 value="{{ old('agencia', $funcionario->agencia) }}">
 @error('agencia')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 value="{{ old('conta_bancaria', $funcionario->conta_bancaria) }}">
 ...
 rows="4">{{ old('observacoes', $funcionario->observacoes) }}</textarea>
 @error('observacoes')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 value="{{ old('salario', $funcionario->salario) }}" step="0.01" min="0" placeholder="0.00">
 @error('salario')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 <option value="percentual" {{ old('tipo_comissao', $funcionario->tipo_comissao) == 'percentual' ? 'selected' : '' }}>Percentual</option>
 <option value="fixa" {{ old('tipo_comissao', $funcionario->tipo_comissao) == 'fixa' ? 'selected' : '' }}>Fixa</option>
 </select>
 @error('tipo_comissao')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 ...
 value="{{ old('percentual_comissao', $funcionario->percentual_comissao) }}" 
