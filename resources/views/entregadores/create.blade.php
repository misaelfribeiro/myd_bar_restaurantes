@extends('layouts.app')
@section('title', 'Cadastrar Entregador')
@section('content')
<div class="container-fluid">
 <div class="d-flex justify-content-between align-items-center mb-4">
 <h1 class="h3 text-gray-800">
 <i class="fas fa-plus-circle mr-2"></i>Cadastrar Entregador
 </h1>
 ...
 <i class="fas fa-user-plus mr-2"></i>Dados do Entregador
 </h6>
 </div>
 <div class="card-body">
 <form method="POST" action="{{ route('entregadores.store') }}" enctype="multipart/form-data">
 @csrf
 <!-- Dados Pessoais -->
 <div class="row">
 <div class="col-12">
 ...
 <option value="">Selecione...</option>
 <option value="interno" {{ old('tipo') == 'interno' ? 'selected' : '' }}>Interno (Funcionário)</option>
 <option value="externo" {{ old('tipo') == 'externo' ? 'selected' : '' }}>Externo (App)</option>
 </select>
 @error('tipo')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 ...
 <option value="">Selecione...</option>
 <option value="moto" {{ old('tipo_veiculo') == 'moto' ? 'selected' : '' }}>Motocicleta</option>
 <option value="carro" {{ old('tipo_veiculo') == 'carro' ? 'selected' : '' }}>Carro</option>
 <option value="bicicleta" {{ old('tipo_veiculo') == 'bicicleta' ? 'selected' : '' }}>Bicicleta</option>
 <option value="pe" {{ old('tipo_veiculo') == 'pe' ? 'selected' : '' }}>A pé</option>
 </select>
 @error('tipo_veiculo')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 ...
 <!-- Dados do Veículo (aparece apenas para moto/carro) -->
 <div id="veiculo-fields" style="display: none;">
 <div class="row">
 <div class="col-md-3">
 <div class="form-group">
 <label for="marca_veiculo">Marca</label>
 <input type="text" class="form-control @error('marca_veiculo') is-invalid @enderror" 
 id="marca_veiculo" name="marca_veiculo" value="{{ old('marca_veiculo') }}">
 @error('marca_veiculo')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 id="modelo_veiculo" name="modelo_veiculo" value="{{ old('modelo_veiculo') }}">
 ...
 id="placa_veiculo" name="placa_veiculo" value="{{ old('placa_veiculo') }}" 
 ...
 id="ano_veiculo" name="ano_veiculo" value="{{ old('ano_veiculo') }}" 
 ...
 id="cor_veiculo" name="cor_veiculo" value="{{ old('cor_veiculo') }}">
 @error('cor_veiculo')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 id="cnh_numero" name="cnh_numero" value="{{ old('cnh_numero') }}">
 @error('cnh_numero')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 <option value="">Selecione...</option>
 <option value="A" {{ old('cnh_categoria') == 'A' ? 'selected' : '' }}>A</option>
 <option value="B" {{ old('cnh_categoria') == 'B' ? 'selected' : '' }}>B</option>
 <option value="AB" {{ old('cnh_categoria') == 'AB' ? 'selected' : '' }}>AB</option>
 <option value="C" {{ old('cnh_categoria') == 'C' ? 'selected' : '' }}>C</option>
 <option value="D" {{ old('cnh_categoria') == 'D' ? 'selected' : '' }}>D</option>
 <option value="E" {{ old('cnh_categoria') == 'E' ? 'selected' : '' }}>E</option>
 </select>
 @error('cnh_categoria')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 ...
 id="cnh_validade" name="cnh_validade" value="{{ old('cnh_validade') }}">
 @error('cnh_validade')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 </div>
 ...
 <div class="col-12">
 <h6 class="text-primary font-weight-bold mb-3">
 <i class="fas fa-file-upload mr-2"></i>Documentos Obrigatórios
 </h6>
 </div>
 <div class="col-md-3">
 <div class="form-group">
 ...
 id="foto_rg" name="foto_rg" accept="image/*" required>
 @error('foto_rg')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 ...
 id="foto_cpf" name="foto_cpf" accept="image/*" required>
 @error('foto_cpf')
 <div class="invalid-feedback">{{ $message }}</div>
 @enderror
 <small class="form-text text-muted">JPG, PNG (máx. 2MB)</small>
 ...
 id="foto_entregador" name="foto_entregador" accept="image/*" required>
 ...
 id="foto_comprovante_endereco" name="foto_comprovante_endereco" accept="image/*" required>
 ...
 <div class="col-md-3" id="foto-cnh-field" style="display: none;">
 <div class="form-group">
 ...
 <a href="{{ route('entregadores.index') }}" class="btn btn-secondary mr-2">
 <i class="fas fa-times mr-2"></i>Cancelar
 </a>
 <button type="submit" class="btn btn-primary">
 <i class="fas fa-save mr-2"></i>Cadastrar Entregador
 </button>
 </div>
 </div>
 </form>
...
function toggleCNHFields() {
 ...
 const cnhFields = ['cnh_numero', 'cnh_categoria', 'cnh_validade', 'foto_cnh'];
 ...
 if (element && field !== 'foto_cnh') {
 element.setAttribute('required', 'required');
 }
 });
 document.getElementById('foto_cnh').setAttribute('required', 'required');
 } else {
